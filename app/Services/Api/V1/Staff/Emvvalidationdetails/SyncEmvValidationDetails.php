        ...
        try {
            ...
            if($emvvalidations_update){
                ...
                $input_pawning_validation_details = [
                    'lender_name' => $request->pvd_lender_name,
                    'lender_address' => $request->pvd_lender_address,
                    ...
                    'reason' => $request->pvd_reason,
                    'interest' => $request->pvd_interest,
                    'offense_history' => $request->pvd_offense_history,
                    'offense_date' => $request->pvd_offense_date,
                    'remarks' => $request->pvd_remarks,
                    'staff_intervention' => $request->pvd_staff_intervention,
                    'other_details' => $request->pvd_other_details,
                    'created_at' => $request->evd_created_at,
                ];
                ...
                if($response_nv){
                    ...
                    if($response_evd){
                        $input_other_card_validations_1 = [
                            'card_holder_name' => $request->ocv_card_holder_name_1,
                            ...
                            'release_by' => $request->ocv_release_by_1,
                            'release_place' => $request->ocv_release_place_1,
                            'card_physically_presented' => $request->ocv_card_physically_presented_1,
                            'card_pin_is_attached' => $request->ocv_card_pin_is_attached_1,
                            'reason_not_presented' => $request->ocv_reason_not_presented_1,
                            'reason_unclaimed' => $request->ocv_reason_unclaimed_1,
                            ...
                            'pawning_remarks' => $request->ocv_pawning_remarks_1,
                            'emv_validation_detail_id' => $response_evd->id,
                            'created_at' => $request->evd_created_at,
                        ];

                        $input_other_card_validations_2 = [
                            'card_holder_name' => $request->ocv_card_holder_name_2,
                            ...
                            'release_by' => $request->ocv_release_by_2,
                            'release_place' => $request->ocv_release_place_2,
                            'card_physically_presented' => $request->ocv_card_physically_presented_2,
                            'card_pin_is_attached' => $request->ocv_card_pin_is_attached_2,
                            'reason_not_presented' => $request->ocv_reason_not_presented_2,
                            'reason_unclaimed' => $request->ocv_reason_unclaimed_2,
                            ...
                            'pawning_remarks' => $request->ocv_pawning_remarks_2,
                            'emv_validation_detail_id' => $response_evd->id,
                            'created_at' => $request->evd_created_at,
                        ];

                        $input_other_card_validations_3 = [
                            'card_holder_name' => $request->ocv_card_holder_name_3,
                            ...
                            'release_by' => $request->ocv_release_by_3,
                            'release_place' => $request->ocv_release_place_3,
                            'card_physically_presented' => $request->ocv_card_physically_presented_3,
                            'card_pin_is_attached' => $request->ocv_card_pin_is_attached_3,
                            'reason_not_presented' => $request->ocv_reason_not_presented_3,
                            'reason_unclaimed' => $request->ocv_reason_unclaimed_3,
                            ...
                            'pawning_remarks' => $request->ocv_pawning_remarks_3,
                            'emv_validation_detail_id' => $response_evd->id,
                            'created_at' => $request->evd_created_at,
                        ];

                        $input_other_card_validations_4 = [
                            'card_holder_name' => $request->ocv_card_holder_name_4,
                            ...
                            'release_by' => $request->ocv_release_by_4,
                            'release_place' => $request->ocv_release_place_4,
                            'card_physically_presented' => $request->ocv_card_physically_presented_4,
                            'card_pin_is_attached' => $request->ocv_card_pin_is_attached_4,
                            'reason_not_presented' => $request->ocv_reason_not_presented_4,
                            'reason_unclaimed' => $request->ocv_reason_unclaimed_4,
                            ...
                            'pawning_remarks' => $request->ocv_pawning_remarks_4,
                            'emv_validation_detail_id' => $response_evd->id,
                            'created_at' => $request->evd_created_at,
                        ];

                        $input_other_card_validations_5 = [
                            'card_holder_name' => $request->ocv_card_holder_name_5,
                            ...
                            'release_by' => $request->ocv_release_by_5,
                            'release_place' => $request->ocv_release_place_5,
                            'card_physically_presented' => $request->ocv_card_physically_presented_5,
                            'card_pin_is_attached' => $request->ocv_card_pin_is_attached_5,
                            'reason_not_presented' => $request->ocv_reason_not_presented_5,
                            'reason_unclaimed' => $request->ocv_reason_unclaimed_5,
                            ...
                            'pawning_remarks' => $request->ocv_pawning_remarks_5,
                            'emv_validation_detail_id' => $response_evd->id,
                            'created_at' => $request->evd_created_at,
                        ];
