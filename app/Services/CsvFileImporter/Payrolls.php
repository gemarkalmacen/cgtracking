        ...
        try{
            ...
            if($upload_history->save()){
                $query = sprintf('
                    ...
                    SET 
                        period = @col1, year = @col2, payroll_type = @col3, region = @col4, province = @col5, municipality = @col6, barangay = @col7, address_psgc = @col8, lastname = @col9, firstname = @col10, middlename = @col11, household_id = @col12, hhset = @col13, mop = @col14, card = @col15, payroll_date = @col16, educ_dc_elem = @col17, educ_jr_hs = @col18, educ_sr_hs = @col19, educ_total_hs = @col20, total_educ = @col21, health = @col22, rice = @col23, gross_amount = @col24, adjustment_amount = @col25, net_amount = @col26, `set` = @col27, set_group = @col28, created_at = CURRENT_TIMESTAMP, upload_history_id = '.$upload_history->id.'
                ', ($file_path));
