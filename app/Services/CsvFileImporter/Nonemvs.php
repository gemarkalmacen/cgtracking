        ...
        if($upload_history->save()){
            $query = sprintf('
                ...
                SET 
                    ...
                    middle_name = @col5, 
                    naa_address = @col6, 
                    cif_permanent_address = @col7, 
                    cif_present_address = @col8, 
                    nationality_cif_tel_no = @col9, 
                    entry_number = @col10, 
                    card_status = @col11, 
                    birthday = @col12, 
                    balance_as_of = @col13, 
                    account_balance = @col14, 
                    hh_id = @col15, 
                    card_holder_status = @col16, 
                    province = @col17, 
                    municipality = @col18, 
                    barangay = @col19, 
                    hh_first_name = @col20, 
                    hh_middle_name = @col21, 
                    hh_last_name = @col22, 
                    hh_ext_name = @col23, 
                    hh_birthdate = @col24, 
                    entry_id = @col25, 
                    mothers_maiden_name = @col26, 
                    client_status = @col27, 
                    payment_mode = @col28, 
                    hh_set = @col29, 
                    set_group = @col30,
                    hh_card_number = @col31,
                    kyc_remarks = @col32,
                    account_number_remarks = @col33,
                    age_bracket = @col34,
                    amount_bracket = @col35,
                    nma_remarks = @col36,
                    nma_remarks_reason = @col37,
                    nma_recommended_action = @col38,
