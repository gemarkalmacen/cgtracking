        ...
        try{
            ...
            if($upload_history->save()){
                $query = sprintf('
                    ...
                    SET
                    hh_id = @col1, hh_set_group = @col2, last_name = @col3, first_name = @col4, middle_name = @col5, ext_name = @col6, hh_status = @col7, province = @col8, municipality = @col9, barangay = @col10, sex = @col11, grantee_card_number = @col12, grantee_distribution_status = @col13, grantee_card_release_date = @col14, other_card_number_1 = @col15, other_card_holder_1 = @col16, other_card_distribution_status_1 = @col17, other_card_release_date_1 = @col18, other_card_number_2 = @col19, other_card_holder_2 = @col20, other_card_distribution_status_2 = @col21, other_card_release_date_2 = @col22, nma_amount = @col23, created_at = CURRENT_TIMESTAMP, upload_history_id = '.$upload_history->id.'
                    ', ($file_path));
                DB::commit();
