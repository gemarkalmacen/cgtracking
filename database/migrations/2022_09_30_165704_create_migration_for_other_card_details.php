...
class CreateMigrationForOtherCardDetails extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('other_card_details', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('pawning_remarks')->nullable();
    ...
    {
        Schema::dropIfExists('other_card_details');
    }
}
