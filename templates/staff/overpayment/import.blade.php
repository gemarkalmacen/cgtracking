...
@extends('layouts.staff.main', ['page' => 'overpayment/import', 'data' => []])

@section('title', __('staff/titles.reference-over_payment-import'))
...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">{{ __('staff/titles.reference-over_payment-import')  }}</h3>
        </div>
        <div class="card-toolbar">
        </div>
    </div>
    <div class="card-body">
        <form id="overpaymentImport" action="{!! route('staff.overpayment.overpaymentload') !!}" method="POST" enctype="multipart/form-data" class="frm" novalidate="novalidate">
            {!! @csrf_field() !!}
            @include ('staff.overpayment.partials.import')
        </form>
