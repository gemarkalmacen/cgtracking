...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">{{ __('staff/titles.library-psgc-import')  }}</h3>
        </div>
        <div class="card-toolbar">
        </div>
    </div>
    <div class="card-body">
        <form id="psgcImport" action="{!! route('staff.psgc.psgcimport') !!}" method="POST" enctype="multipart/form-data" class="frm" novalidate="novalidate">
            {!! @csrf_field() !!}
            @include ('staff.psgc.partials.import')
        </form>
